...
@section('content')
<a href="{{ route('transaksi.create') }}" class="btn btn-primary mb-3">Tambah Penjualan</a>
<div class="card">
        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('transaksi.destroy', $trans->produk_id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('delete')
